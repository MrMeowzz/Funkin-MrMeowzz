...
class DiscordClient
{
	...
	public static function changePresence(details:String, state:Null<String>, ?largeImageKey : String = 'icon', ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		var smallImageText:String = if(largeImageKey.contains('dead')) "Against " + smallImageKey else "Playing as " + (PlayState.swappedsides ? 'player2' : 'player1') + ': ' + smallImageKey;
